...
namespace Acuario.Controllers
{
    public class ControllerCompras
    {
        ...
        public EntitieCompra GetCompraById(int idCompra)
        {
            ...
            DataTable dt = ManagerDB.Instance.ExecuteQuery("SELECT * FROM Compras WHERE ID_Compra = " + idCompra);
        ...
        public Boolean GenerarCompra(EntitieCompra compra)
        {
            ...
            ManagerDB.Instance.Execute("INSERT INTO Compras(ID_Transaccion, ID_Cuenta, Cuenta, Total, Fecha_Hora) " +
            ...
            int idCompra = Convert.ToInt32(ManagerDB.Instance.ExecuteQuery("SELECT MAX(ID_Compra) from Compras").Rows[0][0]);
        ...
        public Boolean RollbackCompra(int idCompra)
        {
            ...
            ManagerDB.Instance.Execute("DELETE FROM Compra_Items WHERE ID_Compra = " + idCompra);
            ManagerDB.Instance.Execute("DELETE FROM Compras WHERE ID_Compra = " + idCompra);
        ...
        public Boolean GenerarItems(List<EntitieCompraItem> items)
        {
            for (int i = 0; i < items.Count; i++)
            {
                ...
                ManagerDB.Instance.Execute("INSERT INTO Compra_Items(ID_Compra, ID_Pez, Nombre_Pez, Cantidad, Subtotal) " +
        ...
        public List<EntitieCompraItem> GetItems()
        {
            ...
            DataTable dt = ManagerDB.Instance.ExecuteQuery("SELECT * FROM Compra_Items");
        ...
        public List<EntitieCompraItem> GetItemsByIdCompra(int idCompra)
        {
            ...
            DataTable dt = ManagerDB.Instance.ExecuteQuery("SELECT * FROM Compra_Items WHERE ID_Compra = " + idCompra);
