...
namespace Acuario.Controllers
{
    public class ControllerPrecios
    {
        ...
        {
            ManagerDB.Instance.Execute("INSERT INTO Precios(Precio_Minorista, Precio_Mayorista, Precio_Oferta, Precio_Distribuidor) " +
            ...
            return Convert.ToInt32(ManagerDB.Instance.ExecuteQuery("SELECT MAX(ID_Precio) FROM Precios").Rows[0][0]);
        }
        ...
        public EntitiePrecio GetPrecioById(int idPrecio)
        {
            ...
            DataTable dt = ManagerDB.Instance.ExecuteQuery("SELECT * FROM Precios WHERE ID_Precio = " + idPrecio);
