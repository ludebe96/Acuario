...
namespace Acuario.Controllers
{
    public class ControllerPeces
    {
        ...
        public List<EntitiePezEspecie> GetEspecies()
        {
            ...
            DataTable dt = ManagerDB.Instance.ExecuteQuery("SELECT * FROM Pez_Especies");
        ...
        public List<EntitiePezEspecie> GetEspecies(String nombre)
        {
            ...
            DataTable dt = ManagerDB.Instance.ExecuteQuery("SELECT * FROM Pez_Especies WHERE Nombre LIKE '%" + nombre + "%'");
        ...
        public EntitiePezEspecie GetEspecieById(int idEspecie)
        {
            ...
            DataTable dt = ManagerDB.Instance.ExecuteQuery("SELECT * FROM Pez_Especies WHERE ID_Pez_Especie = " + idEspecie);
        ...
        {
            return ManagerDB.Instance.ExecuteQuery("SELECT * FROM Pez_Especies WHERE Nombre = '" + nombre + "'").Rows.Count > 0;
        }

        public void CrearEspecie(EntitiePezEspecie especie, Boolean crearVariedadDefault)
        {
            ManagerDB.Instance.Execute("INSERT INTO Pez_Especies(Nombre) VALUES('" + especie.GetNombre() + "')");

            if (crearVariedadDefault)
            {
                int idEspecie = Convert.ToInt32(ManagerDB.Instance.ExecuteQuery("SELECT MAX(ID_Pez_Especie) FROM Pez_Especies").Rows[0][0]);
        ...
        {
            ManagerDB.Instance.Execute("UPDATE Pez_Especies SET Nombre = '" + especie.GetNombre() + "' " +
               "WHERE ID_Pez_Especie= " + idEspecie);
        }

        public void EliminarEspecie(int idEspecie)
        {
            ManagerDB.Instance.Execute("UPDATE Pez_Variedades SET ID_Pez_Especie = 0 WHERE ID_Pez_Especie = " + idEspecie);
            ManagerDB.Instance.Execute("DELETE FROM Pez_Especies WHERE ID_Pez_Especie = " + idEspecie);
        }
        ...
        public List<EntitiePezVariedad> GetVariedades()
        {
            ...
            DataTable dt = ManagerDB.Instance.ExecuteQuery("SELECT * FROM Pez_Variedades");
        ...
        public List<EntitiePezVariedad> GetVariedadesByIdEspecie(int idEspecie)
        {
            ...
            DataTable dt = ManagerDB.Instance.ExecuteQuery("SELECT * FROM Pez_Variedades WHERE ID_Pez_Especie = " + idEspecie);
        ...
        public EntitiePezVariedad GetVariedadById(int idVariedad)
        {
            ...
            DataTable dt = ManagerDB.Instance.ExecuteQuery("SELECT * FROM Pez_Variedades WHERE ID_Pez_Variedad = " + idVariedad);
        ...
        public Boolean VariedadExistente(String nombre)
        {
            return ManagerDB.Instance.ExecuteQuery("SELECT * FROM Pez_Variedades WHERE Nombre = '" + nombre + "'").Rows.Count > 0;
        }

        public void CrearVariedad(EntitiePezVariedad variedad)
        {
            ManagerDB.Instance.ExecuteQuery("INSERT INTO Pez_Variedades(ID_Pez_Especie, Nombre, Es_Default) " +
        ...
        {
            ManagerDB.Instance.Execute("UPDATE Pez_Variedades SET ID_Pez_Especie = " + variedad.GetIdPezEspecie() + ", " +
        ...
        {
            ManagerDB.Instance.Execute("UPDATE Peces SET ID_Pez_Variedad = 0 WHERE ID_Pez_Variedad = " + idVariedad);
            ManagerDB.Instance.Execute("DELETE FROM Pez_Variedades WHERE ID_Pez_Variedad = " + idVariedad);
        }
        ...
        public List<EntitiePezTamaño> GetTamaños()
        {
            ...
            DataTable dt = ManagerDB.Instance.ExecuteQuery("SELECT * FROM Pez_Tamaños");
        ...
        public EntitiePezTamaño GetTamañoById(int idTamaño)
        {
            ...
            DataTable dt = ManagerDB.Instance.ExecuteQuery("SELECT * FROM Pez_Tamaños WHERE ID_Pez_Tamaño = " + idTamaño);
        ...
        public EntitiePez GetPezById(int idPez)
        {
            ...
            DataTable dt = ManagerDB.Instance.ExecuteQuery("SELECT * FROM Peces WHERE ID_Pez = " + idPez);
        ...
        {
            return ManagerDB.Instance.ExecuteQuery("SELECT * FROM Peces WHERE ID_Pez_Especie = " + idEspecie + " AND " +
                "ID_Pez_Variedad = " + idVariedad).Rows.Count > 0;
        }

        public void CrearPez(EntitiePez pez)
        {
            ManagerDB.Instance.Execute("INSERT INTO Peces(ID_Pez_Variedad, ID_Pez_Tamaño, ID_Precio, Nombre, Stock) " +
        ...
        {
            ManagerDB.Instance.Execute("UPDATE Peces SET ID_Pez_Variedad = " + pez.GetIdVariedad() + ", " +
